      ...
      <main className="content-shell">
        <section className="hero-panel">
          <div>
            ...
            <h2>Add and remove service categories.</h2>
            <p>Changes here affect the categories used across the marketplace.</p>
          </div>
        ...
        <section className="provider-layout">
          ...
          <section className="panel-card">
            <div className="panel-head">
              <div>
                <p className="section-kicker">Existing categories</p>
                <h3>Category list</h3>
              </div>
            </div>
